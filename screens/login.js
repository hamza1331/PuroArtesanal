    ...
    constructor(props){
      ...
      render(){
        ...
        <Button title="Iniciar sesión" onPress={this.handleSubmit} containerStyle={{borderRadius:15,width:'50%',marginBottom:5}}  buttonStyle={{backgroundColor:'#B17E4E',borderRadius:10}} />
          ...
          <Button title="Registrarse Gratis" onPress={()=>this.props.navigation.navigate('Signup')}  containerStyle={{borderRadius:15,width:'50%'}}  buttonStyle={{backgroundColor:'#7F7472',borderRadius:10}} />
       </KeyboardAvoidingView>
   </ScrollView>
