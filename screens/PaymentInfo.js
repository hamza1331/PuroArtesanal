    ...
    render() {
      ...
      leftComponent={
       ...
       <Header    placement="left"
                  centerComponent={{ text: 'Información de pago', style: { color: 'white',fontSize:22,marginBottom:10} }}
                  ...
                  leftComponent={
                    ...
                    rightComponent={
                        <Text onPress={()=>this.props.navigation.navigate("BankDetails")} style={{fontSize:16,color:'white',textDecorationLine:'underline',fontWeight:'bold',marginLeft:10}}>Detalles del banco</Text>
                    }
                  />
                <ScrollView>
                    <View style={{flex:1,justifyContent:'center',marginTop:3}}>
                      <Text style={{fontSize:16,fontWeight:'bold',textAlign:'center'}}>Envíe su información de pago para crear una cuenta de Stripe Connect que permita recibir pagos.</Text>
                    </View>
                    <View style={{ width: '100%', height: hp('9%'), backgroundColor: 'white', flexDirection: 'row', alignItems: 'center' }}>
                        <Text style={{ marginLeft: 10, color: 'gray', fontSize: 15, fontWeight: 'bold' }}>Seleccione el tipo de negocio</Text>
                    </View>
                    ...
                    <KeyboardAvoidingView>
                            <TextField
                                label='Número de seguridad social (SSN)'
                   ...
                   {this.state.showBusiness && <View style={{ marginTop: 5 }}>
                    ...
                    <KeyboardAvoidingView>
                            <TextField
                                label='Identificación del impuesto'
