...
class HomeScreen extends Component {
        ...
        />
          ...
          centerComponent={
           ...
           leftIcon={
             ...
             shake={true}
             inputContainerStyle={{width:"100%",backgroundColor:'white',borderRadius:12,borderBottomColor:'white'}}
             containerStyle={{marginBottom:23,height:45,flex:1,alignItems:'center',marginLeft:20}}
             rightIcon={
               <Icon
               name='clear'
               type='material'
          ...
          rightComponent={
            <Text onPress={()=>this.props.navigation.navigate("Filter")} style={{fontSize:16,color:'brown',marginBottom:20,marginRight:20}}>Filtrar</Text>
  ...
  <Icon
          ...
          onPress={()=>this.handleCategoryClick('Household')}      
           />
    <Text  style={{textAlign:'center',color:'black'}}>Casa</Text>
  </View>
  <View>
  <Icon   
          name='face'
      ...
      onPress={()=>this.handleCategoryClick('Children')}  
              />
    <Text style={{textAlign:'center',color:'black'}}>para niños</Text>
  </View>
  <View>
  <Icon   
           name='ring'
      ...
      />
    <Text style={{textAlign:'center',color:'black'}}>Joyería</Text>
  </View>
  <View>
  <Icon   
          name='drawing'
      ...
      />
    <Text style={{textAlign:'center',color:'black'}}>Art º</Text>
  </View>
  ...
  <Icon   
      ...
      />
    <Text style={{textAlign:'center',color:'black'}}>Entretenimiento</Text>
  </View>
  <View>
  <Icon   
          name='gift'
      ...
      />
    <Text style={{textAlign:'center',color:'black'}}>Regalos</Text>
  </View>
  ...
  <Icon   
      ...
      />
    <Text style={{textAlign:'center',color:'black'}}>Artesanía</Text>
  </View>
  <View style={{marginLeft:3}}>
  <Icon
          reverse
  ...
  <CardAction 
   ...
   <Button
       ...
       />}
       {this.state.endOfData && <Text>**Fin de los registros**</Text>}
...
<View style={{alignItems:'center'}}>
      ...
      marginBottom:25
            ...
            <Button title="+Elemento de lista" onPress={()=>{
