     ...
     this.googleLogin=this.googleLogin.bind(this)
      ...
      render(){
        ...
        <KeyboardAvoidingView style={{justifyContenty:'center',width:wp('100%'),height:(this.state.orientation==="portrait")?hp('30%'):hp('50%')}}>
          ...
          <Text style={{margin:5,fontWeight:'bold',textAlign:'center'}}>O</Text>
          <Button title="Continuar con el Email" onPress={()=>this.props.navigation.navigate('LoginScreen')}  containerStyle={{width:'70%',alignSelf:'center',borderRadius:50}}  buttonStyle={{backgroundColor:'#7F7472',alignSelf:'center',borderRadius:50,width:'100%'}} />
